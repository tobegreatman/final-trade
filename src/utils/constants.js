...
export const IRON_RULES = [
  { id: 1, rule: '止损不可撤销', desc: '到了止损位必须卖，不抱任何幻想', consequence: '小亏变大亏，最终大亏' },
  { id: 2, rule: '不追涨杀跌', desc: '没有信号不进场，不因 FOMO 买入', consequence: '高位接盘/低位割肉' },
  { id: 3, rule: '不逆势满仓', desc: '熊市不加杠杆，震荡市不满仓', consequence: '爆仓/深度套牢风险' },
  { id: 4, rule: '不在亏损仓位加仓', desc: '亏了不加码，止损而非补仓', consequence: '亏损放大，复利杀手' },
  { id: 5, rule: '不过度交易', desc: '有信号才交易，每月交易不超过 10 次', consequence: '手续费+滑点吞噬利润' },
  { id: 6, rule: '不碰不懂的票', desc: '没研究过的不买，不跟风听消息', consequence: '盲目赌博，必亏' },
  { id: 7, rule: '不临时起意', desc: '盘中不产生新想法，所有计划盘前制定', consequence: '情绪化操作，破坏系统' }
]
...
export const MARKET_STATUS = {
  bull: { label: '牛市', tag: 'tag-green', maxPosition: '80-100%', strategy: '趋势突破' },
  'bull-lean': { label: '偏多', tag: 'tag-green', maxPosition: '50-70%', strategy: '回调买入' },
  neutral: { label: '震荡', tag: 'tag-yellow', maxPosition: '50-70%', strategy: '回调买入' },
  'bear-lean': { label: '偏空', tag: 'tag-yellow', maxPosition: '20-40%', strategy: '仅观望' },
  bear: { label: '熊市', tag: 'tag-red', maxPosition: '0-20%', strategy: '空仓' }
}
...
export const EMOTIONS = [
  ...
  { key: 'fatigue', name: '疲惫', trigger: '盯盘过度，决策质量下降', response: '设定交易时段，其余时间不盯盘' }
]
